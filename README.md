...
>> #### 静态搭建
>>
>> - *el-form*、*el-form-item* 构建
>> - *el-imput* 收集 *SKU名称*、*价格*等
>> - *el-select*、*el-option* 收集平台属性、销售属性
>> - *el-table* 收集、展示图片列表信息
>>
>> #### 功能实现
>>
>> - 初始化数据
>>   - 获取点击项 *SPU名称* 展示
>>   - 获取当前 *SPU* 处在 *category1Id*、*category2Id*、*category3Id*
>>   - 发送请求获取当前 *category* 下所有平台属性
>>   - 发送请求获取当前 *SPU* 所有销售属性
>>   - 发送请求获取当前 *SPU* 所有图片信息
>> - 保存
>>   - 收集所有数据，作为请求参数
...
>> #### API
>>
>> - 根据 *category1Id*、 *category2Id*、 *category3Id* 发送请求获取平台属性
>> - 根据传入 *spuId* 发送请求获取当前 *SPU* 所有销售属性
>> - 根据传入 *spuId* 发送请求获取当前 *SPU* 所有图片
>> - 请求添加 *SKU*，传入收集好的信息
>>